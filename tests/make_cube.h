...
inline kigumi::Kigumi_mesh<K, FaceData> make_cube(const typename K::Point_3& min,
                                                  ...
                                                  const FaceData& data) {
  kigumi::Polygon_soup<K, FaceData> soup;
  ...
  soup.add_face({vh1, vh2, vh6});
  soup.add_face({vh1, vh3, vh4});
  soup.add_face({vh1, vh4, vh2});
  soup.add_face({vh1, vh5, vh7});
  soup.add_face({vh1, vh6, vh5});
  soup.add_face({vh1, vh7, vh3});
  soup.add_face({vh8, vh2, vh4});
  soup.add_face({vh8, vh3, vh7});
  soup.add_face({vh8, vh4, vh3});
  soup.add_face({vh8, vh5, vh6});
  soup.add_face({vh8, vh6, vh2});
  soup.add_face({vh8, vh7, vh5});
